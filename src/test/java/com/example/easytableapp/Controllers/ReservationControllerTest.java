...
@Test
    public void datePickerAndTimePickerShouldReturnNotEmptyLists(){
    ReservationController controller = new ReservationController(new ReservationService(new ReservationRepository() {
        @Override
    ...
    }), new ReservationValidation(new ReservationRepository() {
        @Override
        public Reservation findByReservationTime(LocalTime reservationTime) {
            return null;
        }
    ...
    assertNotEquals(new ArrayList<DatePicker>(), controller.pickDate());
    assertNotEquals(new ArrayList<DatePicker>(), controller.pickTime());
}

@Test
    public void createReservationShouldReturnMappingOfNextPage(){
    Reservation reservation = new Reservation(3);
    String response = "redirect:/people/new/"+ reservation.getId();
    ReservationController controller = new ReservationController(new ReservationService(new ReservationRepository() {
        @Override
        public Reservation findByReservationTime(LocalTime reservationTime) {
            return null;
    ...
    assertEquals(response, controller.createReservation(reservation, new BindingResult() {
        @Override
...
@Test
    public void createReservationShouldReturnMappingOfCurrentPageIfIncorrectInput(){
    Reservation reservation = new Reservation(3);
    ReservationController controller = new ReservationController(new ReservationService(new ReservationRepository() {
        @Override
        public Reservation findByReservationTime(LocalTime reservationTime) {
    ...
    assertEquals("reservation/create", controller.createReservation(reservation, new BindingResult() {
        @Override
        public Object getTarget() {
            return null;
        }
